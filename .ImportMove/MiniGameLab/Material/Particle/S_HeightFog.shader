...
Shader "MiniGameLab/Environment/Height Fog"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_Density("Density", Range( 0.01 , 0.1)) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float eyeDepth2 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _FogColor.rgb;
				float Alpha = ( _FogColor.a * saturate( ( ( eyeDepth2 - screenPos.w ) * _Density ) ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( _FogColor.a * saturate( ( ( eyeDepth2 - screenPos.w ) * _Density ) ) );
...
ASEEND*/
//CHKSM=6A8DB6E1BB1742933310556FAE292025F12837F1