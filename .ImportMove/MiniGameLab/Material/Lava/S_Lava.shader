...
Shader "MiniGameLab/Environment/S_Lava"
{
	Properties
	{
		...
		_FresnelPower("Fresnel Power", Range( 0.1 , 2)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord20 = IN.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 panner44 = ( _Time.x * float2( 0,0 ) + texCoord20);
				float2 temp_cast_3 = (_OffsetSpeed).xx;
				float2 texCoord29 = IN.ase_texcoord3.xy * float2( 0.5,0.5 ) + float2( 0,0 );
				float2 panner27 = ( _Time.x * temp_cast_3 + texCoord29);
				float2 lerpResult25 = lerp( panner44 , ( panner44 * tex2D( _Noise, panner27 ).r ) , _DistortionStrength);
				float4 lerpResult36 = lerp( _Color1 , _Color2 , tex2D( _Noise, lerpResult25 ).r);
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 ase_worldNormal = IN.ase_texcoord4.xyz;
				float fresnelNdotV38 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode38 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV38, _FresnelPower ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( lerpResult36 + ( _FresnelColor * fresnelNode38 ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
0;112;1440;735;2253.178;308.8857;1.463535;True;False
Node;AmplifyShaderEditor.FresnelNode;38;-7.126952,414.2497;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.TimeNode;28;-2091.38,612.4791;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;13;-1816.3,-90.3;Inherit;True;Property;_Noise;Noise;1;0;Create;True;0;0;0;False;0;False;None;234e8b2dfce5d414282f665b91cd1c1f;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.PannerNode;44;-1214.265,52.48326;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;241.173,320.6498;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;35;-263.2273,-283.8502;Inherit;False;Property;_Color1;Color 1;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.2560973,0.25,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;25;-720.4659,326.3994;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;41;294.473,30.74968;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;36;31.8728,6.049805;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;37;-287.9272,-75.8502;Inherit;False;Property;_Color2;Color 2;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.6582798,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-1607.099,327.8001;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;234e8b2dfce5d414282f665b91cd1c1f;234e8b2dfce5d414282f665b91cd1c1f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-303.5269,591.0496;Inherit;False;Property;_FresnelPower;Fresnel Power;7;0;Create;True;0;0;0;False;0;False;1;1.66;0.1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-298.327,510.4496;Inherit;False;Property;_FresnelScale;Fresnel Scale;6;0;Create;True;0;0;0;False;0;False;0;47.91;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-628.532,22.23608;Inherit;True;Property;_NoiseMap;Noise Map;0;0;Create;True;0;0;0;False;0;False;-1;234e8b2dfce5d414282f665b91cd1c1f;234e8b2dfce5d414282f665b91cd1c1f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;26;-1555.123,535.8756;Inherit;False;Property;_DistortionStrength;Distortion Strength;2;0;Create;True;0;0;0;False;0;False;0;0.14;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-2088.29,464.5415;Inherit;False;Property;_OffsetSpeed;Offset Speed;3;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;29;-2140.819,182.9077;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.5,0.5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;27;-1833.38,379.4791;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;20;-1476.648,5.492752;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;43;-0.6270368,219.2496;Inherit;False;Property;_FresnelColor;Fresnel Color;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.01776157,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;31;-1718.306,112.2961;Inherit;False;Property;_Tile;Tile;0;0;Create;True;0;0;0;False;0;False;0;6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-922.7708,105.6584;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;422.4999,1.3;Float;False;True;-1;2;ASEMaterialInspector;0;3;MiniGameLab/Environment/S_Lava;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;1;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Universal Render Pipeline/Simple Lit;0;0;Standard;22;Surface;1;637813826593228170;  Blend;2;637813826606895870;Two Sided;1;0;Cast Shadows;0;637811951873142530;  Use Shadow Threshold;0;0;Receive Shadows;0;637811951886026041;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=48ACD5C5AE2E8F81D6A24F8170F0D6F022CA9E51