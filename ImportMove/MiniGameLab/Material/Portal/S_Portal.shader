...
Shader "MiniGameLab/S_Portal"
{
	Properties
	{
		...
		_TwirlStrenght("Twirl Strenght", Range( 0 , 20)) = 8.354572
		_TwirlTile("Twirl Tile", Range( 0.1 , 2)) = 0.1
		_TwirlSpeed("Twirl Speed", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_cast_0 = (_TwirlTile).xx;
				float2 texCoord11 = IN.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (( _TwirlTile / 2.0 )).xx;
				float2 center45_g1 = temp_cast_1;
				float2 delta6_g1 = ( texCoord11 - center45_g1 );
				...
				float2 temp_cast_2 = (( _TwirlSpeed * ( _TimeParameters.x ) )).xx;
				...
				float2 coords29 = appendResult44_g1 * _VoronoiScale;
				float2 id29 = 0;
				float2 uv29 = 0;
				float voroi29 = voronoi29( coords29, time29, id29, uv29, 0, voronoiSmoothId29 );
				float2 uv_RadialMask = IN.ase_texcoord3.xy * _RadialMask_ST.xy + _RadialMask_ST.zw;
				float4 temp_output_25_0 = ( voroi29 * tex2D( _RadialMask, uv_RadialMask ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Tint * temp_output_25_0 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv29 = 0;
				float voroi29 = voronoi29( coords29, time29, id29, uv29, 0, voronoiSmoothId29 );
				float2 uv_RadialMask = IN.ase_texcoord2.xy * _RadialMask_ST.xy + _RadialMask_ST.zw;
				float4 temp_output_25_0 = ( voroi29 * tex2D( _RadialMask, uv_RadialMask ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv29 = 0;
				float voroi29 = voronoi29( coords29, time29, id29, uv29, 0, voronoiSmoothId29 );
				float2 uv_RadialMask = IN.ase_texcoord.xy * _RadialMask_ST.xy + _RadialMask_ST.zw;
				float4 temp_output_25_0 = ( voroi29 * tex2D( _RadialMask, uv_RadialMask ) );
				
				surfaceDescription.Alpha = temp_output_25_0.r;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 voronoiSmoothId29 = 0;
				float2 temp_cast_0 = (_TwirlTile).xx;
				float2 texCoord11 = IN.ase_texcoord1.xy * temp_cast_0 + float2( 0,0 );
				float2 temp_cast_1 = (( _TwirlTile / 2.0 )).xx;
				float2 center45_g1 = temp_cast_1;
				float2 delta6_g1 = ( texCoord11 - center45_g1 );
				float angle10_g1 = ( length( delta6_g1 ) * _TwirlStrenght );
				...
				float2 uv29 = 0;
				float voroi29 = voronoi29( coords29, time29, id29, uv29, 0, voronoiSmoothId29 );
				float2 uv_RadialMask = IN.ase_texcoord1.xy * _RadialMask_ST.xy + _RadialMask_ST.zw;
				float4 temp_output_25_0 = ( voroi29 * tex2D( _RadialMask, uv_RadialMask ) );
...
/*ASEBEGIN
Version=18935
0;110;1440;735;1369.73;71.0892;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;23;-1400.377,63.08305;Inherit;False;Property;_TwirlTile;Twirl Tile;2;0;Create;True;0;0;0;False;0;False;0.1;0.58;0.1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-1060.963,307.8878;Inherit;False;Property;_TwirlSpeed;Twirl Speed;3;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TimeNode;18;-1087.016,388.9392;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-897.8795,349.8247;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-1086.496,-61.60555;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;22;-996.4479,66.93565;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1095.696,223.1945;Inherit;False;Property;_TwirlStrenght;Twirl Strenght;1;0;Create;True;0;0;0;False;0;False;8.354572;20;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-533.7105,321.7893;Inherit;False;Property;_VoronoiScale;Voronoi Scale;4;0;Create;True;0;0;0;False;0;False;4;6.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;10;-734.6428,12.94711;Inherit;True;Twirl;-1;;1;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;26;-342.2525,362.9694;Inherit;True;Property;_RadialMask;RadialMask;5;0;Create;True;0;0;0;False;0;False;-1;e387f662afce60c4cbf4689043469d34;e387f662afce60c4cbf4689043469d34;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;29;-290.5638,34.27746;Inherit;True;0;0;1;0;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;215.1975,-101.6616;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-28.87312,39.49653;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;28;-25.30248,-143.4615;Inherit;False;Property;_Tint;Tint;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;16.94838,2.750784,10.82567,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;474.0477,55.77494;Float;False;True;-1;2;ASEMaterialInspector;0;3;MiniGameLab/S_Portal;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;1;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Universal Render Pipeline/Simple Lit;0;0;Standard;22;Surface;1;637810346272616836;  Blend;2;637810346371655669;Two Sided;1;0;Cast Shadows;0;637810337306573640;  Use Shadow Threshold;0;0;Receive Shadows;0;637810337311761187;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=8C895B32EDBCE7658E58E7DF74CEE8BF93F99ECD