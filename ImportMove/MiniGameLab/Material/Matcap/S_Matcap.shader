		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				half3 worldToViewDir6 = normalize( mul( UNITY_MATRIX_V, float4( IN.ase_normal, 0 ) ).xyz );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2D( _Matcap, (float3( 0,0,0 ) + (worldToViewDir6 - float3( -1,-1,-1 )) * (float3( 1,1,1 ) - float3( 0,0,0 )) / (float3( 1,1,1 ) - float3( -1,-1,-1 ))).xy ) * _Brightness ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
0;53;1440;768;1053.814;85.10069;1;True;False
...
Node;AmplifyShaderEditor.NormalVertexDataNode;5;-1330.758,-38.23347;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;8;-704.142,39.27313;Inherit;True;Property;_Matcap;Matcap;0;0;Create;True;0;0;0;False;0;False;-1;cf604c72bfe36384bb79cecf8a06e552;0d6bf36475e60e1479cdc06321015ab4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-325.748,115.0778;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-579.748,296.0778;Inherit;False;Property;_Brightness;Brightness;1;0;Create;True;0;0;0;False;0;False;0;1.4;0;5;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=64F6D6A1C9EFBE664712A5F44B200804D7A161F3